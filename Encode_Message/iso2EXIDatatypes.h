...
struct iso2ServiceDetailReqType {
	...
	uint16_t ServiceID ;
	uint8_t ServiceScope; // Assuming MAX_SERVICE_SCOPE_LENGTH is the maximum length of a service scope
...
#define iso2ServiceIDListType_ServiceID_ARRAY_SIZE 8
...
//extern size_t iso2PaymentDetailsResType_GenChallenge_BYTES_SIZE; /* XML schema facet length for urn:iso:15118:2:2016:MsgDataTypes,genChallengeType is 16 */
